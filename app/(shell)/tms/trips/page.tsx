...
export default function TMSTrips() {
  ...
  async function toggleOrderLink(tripId: string, orderId: string) {
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12.5 }}>
          <thead>
            <tr style={{ background: "#fff", borderBottom: "2px solid #E4E7EC" }}>
              ...
              {["Reference", "Tags", "From", "To", "Departure", "Arrival", "Trip Status", "Customs", "Orders", "Gross kg", "Load m", "Resource", "Digitoll ID"].map((h, i) => (
