...
const MaritechLogo = () => (
  <svg width="118" height="24" viewBox="0 0 209 43" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M1 1L13 13M13 1L1 13" stroke="#555" strokeWidth="1.8" strokeLinecap="round"/>
            </svg>
          </div>
          <MaritechLogo />
        </div>
        ...
        {allNavItems.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{
              ...
              borderTop: item === allNavItems[0] ? "1px solid #E2E5EA" : undefined,
              transition: "background 0.12s, color 0.12s",
            }}>
              {/* Bullet — 18px wide container to center under icon */}
              <span style={{
                width: 18,
                display: "flex",
                ...
                <span style={{
                  ...
                  height: 6,
                  borderRadius: "50%",
                  background: active ? "#003160" : "#C5CAD4",
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6, cursor: "pointer" }}>
            <div>
              ...
              <div style={{ fontSize: 10, color: "rgba(255,255,255,0.55)", textTransform: "uppercase", letterSpacing: "0.04em" }}>Domain Name</div>
            </div>
            <span style={{ fontFamily: "Material Icons", fontSize: 18, color: "rgba(255,255,255,0.7)", lineHeight: 1, userSelect: "none" }}>arrow_drop_down</span>
          </div>
